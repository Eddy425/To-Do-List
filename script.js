...
function markAsDone(){
  ...
  if (doneBtn.innerHTML === 'Done') {
    ...
    document.querySelector('.taskList').classList.add('strikeThrough');
  } else if (doneBtn.innerHTML === 'Did it') {
    doneBtn.innerHTML = 'Done';
    document,querySelector('.js-done-btn').classList.remove
    ('did-it');
    document.querySelector('.taskList').classList.remove('StrikeThrough');
  }
}